...
class Encoder_overall(Module):
    ...
    def forward(self, features_omics1, features_omics2, features_omics3, adj_spatial_omics1, adj_feature_omics1,
        ...
        emb_bnm_omics1 = self.decoder_omics1(emb_latent_combined, adj_spatial_omics1)
        emb_bnm_omics2 = self.decoder_omics2(emb_latent_combined, adj_spatial_omics2)
        emb_bnm_omics3 = self.decoder_omics3(emb_latent_combined, adj_spatial_omics3)
        ...
        results = {'emb_latent_omics1': emb_latent_omics1,
                   ...
                   'emb_bnm_omics1': emb_bnm_omics1,
                   'emb_bnm_omics2': emb_bnm_omics2,
                   'emb_rbnm_omics3': emb_bnm_omics3,
                   }
